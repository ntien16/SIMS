 ...
 */
public class ProfileJPanelSalemen extends javax.swing.JPanel {
    ...
    public ProfileJPanelSalemen() throws SQLException, ClassNotFoundException {
        initComponents();
        table1();
    ...
    public ProfileJPanelSalemen(String username, String password) throws SQLException, ClassNotFoundException {
        initComponents();
        table1();
